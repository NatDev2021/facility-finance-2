...
@section('content')
    ...
    <!-- Modal -->
    <div class="modal fade" id="personModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input" id="customer" name="customer"
                                value="">
                            <label class="custom-control-label" for="customer">Cliente</label>
                        </div>
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input" id="provider" name="provider"
                                value="">
                            <label class="custom-control-label" for="provider">Fornecedor</label>
                        </div>
                    </div>
